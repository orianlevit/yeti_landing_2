...
var BucketedRateLimiter = /** @class */ (function () {
    function BucketedRateLimiter(_options) {
        ...
        this._refillRate = clampToRange(this._options.refillRate, 0, this._bucketSize, // never refill more than bucket size
        'rate limiter refill rate');
        this._refillInterval = clampToRange(this._options.refillInterval, 0, 86400000, // one day in milliseconds
