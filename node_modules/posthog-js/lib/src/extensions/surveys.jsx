...
var SurveyManager = /** @class */ (function () {
    function SurveyManager(posthog) {
        ...
        this._handlePopoverSurvey = function (survey) {
            ...
            var shadow = retrieveSurveyShadow(survey, _this._posthog).shadow;
            if (delaySeconds <= 0) {
        ...
        this._handleWidget = function (survey) {
            ...
            var _a = retrieveSurveyShadow(survey, _this._posthog), shadow = _a.shadow, isNewlyCreated = _a.isNewlyCreated;
        ...
        this._removeWidgetSelectorListener = function (survey) {
            ...
            if (existing) {
                ...
                logger.info("Removed click listener for survey ".concat(survey.id));
            }
        };
        this._manageWidgetSelectorListener = function (survey, selector) {
            ...
            if (!currentElement.hasAttribute(WIDGET_LISTENER_ATTRIBUTE)) {
                var listener = function (event) {
                    ...
                    var positionStyles = ((_a = survey.appearance) === null || _a === void 0 ? void 0 : _a.position) === SurveyPosition.NextToTrigger
    ...
    SurveyManager.prototype._removeSurveyFromDom = function (survey) {
        try {
            ...
            logger.warn("Failed to remove survey ".concat(survey.id, " from DOM:"), error);
        }
    };
...
export function usePopupVisibility(survey, posthog, millisecondDelay, isPreviewMode, removeSurveyFromFocus, surveyContainerRef) {
    ...
    useEffect(function () {
        ...
        var showSurvey = function () {
            ...
            posthog.capture(SurveyEventName.SHOWN, (_a = {},
                _a[SurveyEventProperties.SURVEY_NAME] = survey.name,
                _a[SurveyEventProperties.SURVEY_ID] = survey.id,
                _a[SurveyEventProperties.SURVEY_ITERATION] = survey.current_iteration,
                _a[SurveyEventProperties.SURVEY_ITERATION_START_DATE] = survey.current_iteration_start_date,
...
var getQuestionComponent = function (_a) {
    ...
    switch (question.type) {
        ...
        default:
            logger.error("Unsupported question type: ".concat(question.type));
            return null;
    }
};
