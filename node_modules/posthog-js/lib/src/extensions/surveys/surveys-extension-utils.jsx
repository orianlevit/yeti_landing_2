...
export var sendSurveyEvent = function (_a) {
    ...
    posthog.capture(SurveyEventName.SENT, __assign((_b = {}, _b[SurveyEventProperties.SURVEY_NAME] = survey.name, _b[SurveyEventProperties.SURVEY_ID] = survey.id, _b[SurveyEventProperties.SURVEY_ITERATION] = survey.current_iteration, _b[SurveyEventProperties.SURVEY_ITERATION_START_DATE] = survey.current_iteration_start_date, _b[SurveyEventProperties.SURVEY_QUESTIONS] = survey.questions.map(function (question) { return ({
        id: question.id,
        question: question.question,
        response: getSurveyResponseValue(responses, question.id),
    }); }), _b[SurveyEventProperties.SURVEY_SUBMISSION_ID] = surveySubmissionId, _b[SurveyEventProperties.SURVEY_COMPLETED] = isSurveyCompleted, _b.sessionRecordingUrl = (_c = posthog.get_session_replay_url) === null || _c === void 0 ? void 0 : _c.call(posthog), _b), responses));
...
export var dismissedSurveyEvent = function (survey, posthog, readOnly) {
    ...
    posthog.capture(SurveyEventName.DISMISSED, __assign(__assign((_a = {}, _a[SurveyEventProperties.SURVEY_NAME] = survey.name, _a[SurveyEventProperties.SURVEY_ID] = survey.id, _a[SurveyEventProperties.SURVEY_ITERATION] = survey.current_iteration, _a[SurveyEventProperties.SURVEY_ITERATION_START_DATE] = survey.current_iteration_start_date, _a[SurveyEventProperties.SURVEY_PARTIALLY_COMPLETED] = Object.values((inProgressSurvey === null || inProgressSurvey === void 0 ? void 0 : inProgressSurvey.responses) || {}).filter(function (resp) { return !isNullish(resp); }).length > 0, _a.sessionRecordingUrl = (_c = posthog.get_session_replay_url) === null || _c === void 0 ? void 0 : _c.call(posthog), _a), inProgressSurvey === null || inProgressSurvey === void 0 ? void 0 : inProgressSurvey.responses), (_b = {}, _b[SurveyEventProperties.SURVEY_SUBMISSION_ID] = inProgressSurvey === null || inProgressSurvey === void 0 ? void 0 : inProgressSurvey.surveySubmissionId, _b[SurveyEventProperties.SURVEY_QUESTIONS] = survey.questions.map(function (question) { return ({
        id: question.id,
        question: question.question,
